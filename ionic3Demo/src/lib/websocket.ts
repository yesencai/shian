...
export class websocket {
    constructor(public device: Device, public regist: RegistCode, public appCtrl: App, public platform: Platform, public toastCtrl: ToastController, public tomato: Tomato, public storage: Storage,private ttConst : TTConst) {
        self = this;
        if (device.uuid != null) {
