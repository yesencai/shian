...
export class TTConst {
  ...
  CLIENT_CHARGE_APAYTYPE = 2; // 支付类型，暂时只有一种，就填 'A'
  CLIENT_CHARGE_APRICE = 3; // 标价金额，必填参数，Int，示例值：88。解释：订单总金额，单位为分，详见支付金额
  // 服务器回复
  ACK_CLIENT_CHARGE = 0x2019;
  ACK_CLIENT_CHARGE_SUCCESS = 1; // 失败0成功1
  ACK_CLIENT_CHARGE_ORDERID = 2; // 订单号
  ACK_CLIENT_CHARGE_DESC = 3; // 订单描述
  ACK_CLIENT_CHARGE_URL = 4; // 支付二维码网址
  ACK_CLIENT_CHARGE_PRICE = 5; // 金额
