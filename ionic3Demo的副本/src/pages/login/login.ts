...
export class LoginPage {
	...
	constructor(public navCtrl: NavController, public navParams: NavParams,
		private platform: Platform,public toastCtrl: ToastController, public loadingCtrl: LoadingController, public common: Common, public ttConst: TTConst, public tomato: Tomato,public storage : Storage,public serve : RegistCode,private backButtonService : BackButtonProvider) {
		let self = this;
	...
	upperCase(){
		let  isMobile = this.common.validatemobile(this.defaul);
		if (isMobile==false) {
			this.codeMessage("您输入的手机号码不正确");
		}
	}
