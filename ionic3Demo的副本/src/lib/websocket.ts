...
var FAppID = "1004";
var FCustomData = "0987654321654";//mac地址或随机数保存起来
...
export class websocket {
    constructor(private device: Device, public regist: RegistCode, public appCtrl: App, public platform: Platform, public toastCtrl: ToastController, public tomato: Tomato, public storage: Storage,private ttConst : TTConst) {
        self = this;
    ...
    //链接webSocket
    registered_connectwebsocket(uuid) {
        if (uuid != null) {
            FCustomData = this.device.uuid;
        }
    ...
    doLoadRegsitCode(RegCode) {
        ...
        if (RegCode.indexOf("REGCODE ") == 0) {
            ...
            var mCustomData = '{' +
                ...
                '}';
            Emitter.fire(this.ttConst.TT_GetConnetAliYunNotification, mCustomData);
